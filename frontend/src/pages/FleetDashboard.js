...
import { 
  ...
  Filter, X, List, Grid3X3
} from "lucide-react";
import { toast } from "sonner";
import axios from "axios";

// Import extracted components
import { JobCard, STATUS_COLORS } from "../components/fleet/JobCard";
import JobDetailDialog from "../components/fleet/JobDetailDialog";
import { DriverDialog, VehicleDialog, AssignDriverDialog } from "../components/fleet/FleetDialogs";
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 bg-white p-4 rounded-lg border">
        <div className="flex items-center gap-2">
          <Button variant={viewMode === "list" ? "default" : "outline"} size="sm" onClick={() => setViewMode("list")} data-testid="list-view-btn">
            <List className="w-4 h-4 mr-1" /> List
          </Button>
          <Button variant={viewMode === "calendar" ? "default" : "outline"} size="sm" onClick={() => setViewMode("calendar")} data-testid="calendar-view-btn">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <Button variant="outline" size="sm" onClick={() => setShowFilters(!showFilters)} data-testid="filters-btn">
